...
void main(void){
    ...
    result = generalInputPin_configureExternalInterrupt(GPIO0, &xint1_isr, 0); 	//Configuring GPIO0 to listen for falling edge and to call function xint1_isr on interrupt. Returns result of operation
    while(1){
        																		//Endless loop
    }
}
